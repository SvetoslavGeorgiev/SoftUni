...
namespace Bombs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                var element = new Queue<int>(Console.ReadLine().Split(" ", StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray());
            ...
            var coordinates = new Queue<string>(Console.ReadLine().Split().ToArray());
