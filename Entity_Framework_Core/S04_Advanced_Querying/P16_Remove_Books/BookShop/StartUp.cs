namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        public static string GetTotalProfitByCategory(BookShopContext context)
        {
            ...
            profitByCategory.ForEach(pc => sb.AppendLine($"{pc.Name} ${pc.Profit:F2}"));
        ...
        public static string GetMostRecentBooks(BookShopContext context)
        {
            ...
            var mostRecentBooks = context
                ...
                {
                    c.Name,
                    theThreeMostRecentBooks = c.CategoryBooks
            ...
            foreach (var category in mostRecentBooks)
            {
                ...
                foreach (var book in category.theThreeMostRecentBooks)
                {
        ...
        public static int RemoveBooks(BookShopContext context)
        {
            ...
            var bookCountForDeleting = 0;


            var bookForDeleting = context
                .Books
                .Where(b => b.Copies < 4200);

            bookCountForDeleting = bookForDeleting.Count();

           
            context.RemoveRange(bookForDeleting);

            context.SaveChanges();

            return bookCountForDeleting;
        }
    }
}
